# -*- coding: utf-8 -*-
"""
Django settings for imagetrac_docker project.
...
LOCAL_APPS = (
    # custom users app
    'imagetrac_docker.users.apps.UsersConfig',
    # Your stuff: custom apps go here
    'imagetrac_docker.b5',
    'imagetrac_docker.taskmanager',
)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'imagetrac_docker.contrib.sites.migrations'
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                ...
                'imagetrac_docker.b5.context_processors.extra_context',
            ],
        },
    },
]
...
ACCOUNT_ADAPTER = 'imagetrac_docker.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'imagetrac_docker.users.adapters.SocialAccountAdapter'

# Custom user app defaults
# Select the correct user model
AUTH_USER_MODEL = 'users.User'
AUTH_PROFILE_MODULE = 'b5.UserProfile'
